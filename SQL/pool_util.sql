rem This script estimates shared pool utilization based on current database  
rem usage. This should be run during peak operation, after all stored
...
rem  
rem Author: Joe Soria jsoria@latis.com
rem Usage: @/export/home/jsoria/SCRIPTS/SQL/pool_util.sql;
 
set echo off;
spool /home/jsoria/SCRIPTS/SQL/pool_util.log;
