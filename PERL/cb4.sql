...
substr(calledno,1,3) ||'-'|| substr(calledno,4,3) ||'-'|| substr(calledno,7,4)  "Called Number",
city_called ||', '|| state_called "Location", substr(call_duration_minutes,3,3) ||':'|| call_duration_seconds "Mins-Secs",
round(to_number(1.35) * to_number(substr(unrounded_price,1,4)||'.'||substr(unrounded_price,5,6)),2) "Charge", 2 "Bill_flag"
...
substr(calledno,1,3) ||'-'|| substr(calledno,4,3) ||'-'|| substr(calledno,7,4)  "Called Number",
city_called ||', '|| state_called "Location", substr(call_duration_minutes,3,3) ||':'|| call_duration_seconds "Mins-Secs",
round(sum(((substr(call_duration_minutes,3,3)*60)+call_duration_seconds)/60) * to_number(b.class1),2) "Charge", 3 "Bill_flag"
...
substr(calledno,1,3) ||'-'|| substr(calledno,4,3) ||'-'|| substr(calledno,7,4)  "Called Number",
city_called ||', '|| state_called "Location", substr(call_duration_minutes,3,3) ||':'|| call_duration_seconds "Mins-Secs",
round(sum(((substr(call_duration_minutes,3,3)*60)+call_duration_seconds)/60) * to_number(b.class2),2) "Charge", 3 "Bill_flag"
from chinook_september a, intrastate_billing_rates b
...
substr(calledno,1,3) ||'-'|| substr(calledno,4,3) ||'-'|| substr(calledno,7,4)  "Called Number",
city_called ||', '|| state_called "Location", substr(call_duration_minutes,3,3) ||':'|| call_duration_seconds "Mins-Secs",
round(sum(((substr(call_duration_minutes,3,3)*60)+call_duration_seconds)/60) * to_number(b.class3),2) "Charge", 3 "Bill_flag"
from chinook_september a, intrastate_billing_rates b
where a.state_called=b.lata
and class_type=3
and state_called='MT'
...
substr(calledno,1,3) ||'-'|| substr(calledno,4,3) ||'-'|| substr(calledno,7,4)  "Called Number",
city_called ||', '|| state_called "Location", substr(call_duration_minutes,3,3) ||':'|| call_duration_seconds "Mins-Secs",
round(sum(((substr(call_duration_minutes,3,3)*60)+call_duration_seconds)/60) * to_number(b.class4),2) "Charge", 3 "Bill_flag"
from chinook_september a, intrastate_billing_rates b
where a.state_called=b.lata
and class_type=4
and state_called='MT'
...
substr(calledno,1,3) ||'-'|| substr(calledno,4,3) ||'-'|| substr(calledno,7,4)  "Called Number",
city_called ||', '|| state_called "Location", substr(call_duration_minutes,3,3) ||':'|| call_duration_seconds "Mins-Secs",
round(sum(((substr(call_duration_minutes,3,3)*60)+call_duration_seconds)/60) * to_number(b.class5),2) "Charge", 3 "Bill_flag"
from chinook_september a, intrastate_billing_rates b
where a.state_called=b.lata
and class_type=5
and state_called='MT'
...
substr(calledno,1,3) ||'-'|| substr(calledno,4,3) ||'-'|| substr(calledno,7,4)  "Called Number",
city_called ||', '|| state_called "Location", substr(call_duration_minutes,3,3) ||':'|| call_duration_seconds "Mins-Secs",
round(sum(((substr(call_duration_minutes,3,3)*60)+call_duration_seconds)/60) * to_number(b.class6),2) "Charge", 3 "Bill_flag"
from chinook_september a, intrastate_billing_rates b
where a.state_called=b.lata
and class_type=6
and state_called='MT'
...
substr(calledno,1,3) ||'-'|| substr(calledno,4,3) ||'-'|| substr(calledno,7,4)  "Called Number",
city_called ||', '|| state_called "Location", substr(call_duration_minutes,3,3) ||':'|| call_duration_seconds "Mins-Secs",
round(sum(((substr(call_duration_minutes,3,3)*60)+call_duration_seconds)/60) * to_number(b.class1),2) "Charge", 4 "Bill_flag"
...
substr(calledno,1,3) ||'-'|| substr(calledno,4,3) ||'-'|| substr(calledno,7,4)  "Called Number",
city_called ||', '|| state_called "Location", substr(call_duration_minutes,3,3) ||':'|| call_duration_seconds "Mins-Secs",
round(sum(((substr(call_duration_minutes,3,3)*60)+call_duration_seconds)/60) * to_number(b.class2),2) "Charge", 4 "Bill_flag"
from chinook_september a, interstate_billing_rates b
where a.terminating_lata=b.lata
and class_type=2
and call_area=2
...
substr(calledno,1,3) ||'-'|| substr(calledno,4,3) ||'-'|| substr(calledno,7,4)  "Called Number",
city_called ||', '|| state_called "Location", substr(call_duration_minutes,3,3) ||':'|| call_duration_seconds "Mins-Secs",
round(sum(((substr(call_duration_minutes,3,3)*60)+call_duration_seconds)/60) * to_number(b.class3),2) "Charge", 4 "Bill_flag"
from chinook_september a, interstate_billing_rates b
where a.terminating_lata=b.lata
and class_type=3
and call_area=2
...
substr(calledno,1,3) ||'-'|| substr(calledno,4,3) ||'-'|| substr(calledno,7,4)  "Called Number",
city_called ||', '|| state_called "Location", substr(call_duration_minutes,3,3) ||':'|| call_duration_seconds "Mins-Secs",
round(sum(((substr(call_duration_minutes,3,3)*60)+call_duration_seconds)/60) * to_number(b.class4),2) "Charge", 4 "Bill_flag"
from chinook_september a, interstate_billing_rates b
where a.terminating_lata=b.lata
and class_type=4
and call_area=2
...
substr(calledno,1,3) ||'-'|| substr(calledno,4,3) ||'-'|| substr(calledno,7,4)  "Called Number",
city_called ||', '|| state_called "Location", substr(call_duration_minutes,3,3) ||':'|| call_duration_seconds "Mins-Secs",
round(sum(((substr(call_duration_minutes,3,3)*60)+call_duration_seconds)/60) * to_number(b.class5),2) "Charge", 4 "Bill_flag"
from chinook_september a, interstate_billing_rates b
where a.terminating_lata=b.lata
and class_type=5
and call_area=2
...
substr(calledno,1,3) ||'-'|| substr(calledno,4,3) ||'-'|| substr(calledno,7,4)  "Called Number",
city_called ||', '|| state_called "Location", substr(call_duration_minutes,3,3) ||':'|| call_duration_seconds "Mins-Secs",
round(sum(((substr(call_duration_minutes,3,3)*60)+call_duration_seconds)/60) * to_number(b.class6),2) "Charge", 4 "Bill_flag"
from chinook_september a, interstate_billing_rates b
where a.terminating_lata=b.lata
and class_type=6
and call_area=2
...
substr(calledno,1,3) ||'-'|| substr(calledno,4,3) ||'-'|| substr(calledno,7,4)  "Called Number",
city_called ||', '|| state_called "Location", substr(call_duration_minutes,3,3) ||':'|| call_duration_seconds "Mins-Secs",
round(sum(((substr(call_duration_minutes,3,3)*60)+call_duration_seconds)/60) * .025,2) "Charge", 5 "Bill_flag"
from chinook_september a
where call_area=2
and prcmp_id != 3
...
substr(calledno,1,3) ||'-'|| substr(calledno,4,3) ||'-'|| substr(calledno,7,4)  "Called Number",
city_called ||', '|| state_called "Location", substr(call_duration_minutes,3,3) ||':'|| call_duration_seconds "Mins-Secs", 
round(to_number(1.15) * to_number(substr(unrounded_price,1,4)||'.'||substr(unrounded_price,5,6)),2) "Charge", 6 "Bill_flag"
...
--(7)Bill Intra Lata Calls missing from MT
insert into chinook_bill_september
select chinook_id, substr(orig_dt,5,2) ||'/'||  substr(orig_dt,7,2) ||'/'|| substr(orig_dt,1,4)  "Date",
substr(orig_time,1,2) ||':'|| substr(orig_time,3,2) ||':'|| substr(orig_time,5,2)  "Time",
substr(calledno,1,3) ||'-'|| substr(calledno,4,3) ||'-'|| substr(calledno,7,4)  "Called Number",
city_called ||', '|| state_called "Location", substr(call_duration_minutes,3,3) ||':'|| call_duration_seconds "Mins-Secs",
round(sum(((substr(call_duration_minutes,3,3)*60)+call_duration_seconds)/60) * to_number(b.class1),2) "Charge", 7 "Bill_flag"
from chinook_september a, intrastate_billing_rates b
where class_type=1
and prcmp_id != 3
and state_called='MT'
...
substr(calledno,1,3) ||'-'|| substr(calledno,4,3) ||'-'|| substr(calledno,7,4)  "Called Number",
city_called ||', '|| state_called "Location", substr(call_duration_minutes,3,3) ||':'|| call_duration_seconds "Mins-Secs",
round(sum(((substr(call_duration_minutes,3,3)*60)+call_duration_seconds)/60) * to_number(b.class2),2) "Charge", 7 "Bill_flag"
from chinook_september a, intrastate_billing_rates b
where a.state_called=b.lata
and class_type=2
and prcmp_id != 3
...
substr(calledno,1,3) ||'-'|| substr(calledno,4,3) ||'-'|| substr(calledno,7,4)  "Called Number",
city_called ||', '|| state_called "Location", substr(call_duration_minutes,3,3) ||':'|| call_duration_seconds "Mins-Secs",
round(sum(((substr(call_duration_minutes,3,3)*60)+call_duration_seconds)/60) * to_number(b.class3),2) "Charge", 7 "Bill_flag"
from chinook_september a, intrastate_billing_rates b
where a.state_called=b.lata
and class_type=3
and state_called='MT'
...
substr(calledno,1,3) ||'-'|| substr(calledno,4,3) ||'-'|| substr(calledno,7,4)  "Called Number",
city_called ||', '|| state_called "Location", substr(call_duration_minutes,3,3) ||':'|| call_duration_seconds "Mins-Secs",
round(sum(((substr(call_duration_minutes,3,3)*60)+call_duration_seconds)/60) * to_number(b.class4),2) "Charge", 7 "Bill_flag"
from chinook_september a, intrastate_billing_rates b
where a.state_called=b.lata
and class_type=4
and state_called='MT'
...
substr(calledno,1,3) ||'-'|| substr(calledno,4,3) ||'-'|| substr(calledno,7,4)  "Called Number",
city_called ||', '|| state_called "Location", substr(call_duration_minutes,3,3) ||':'|| call_duration_seconds "Mins-Secs",
round(sum(((substr(call_duration_minutes,3,3)*60)+call_duration_seconds)/60) * to_number(b.class5),2) "Charge", 7 "Bill_flag"
from chinook_september a, intrastate_billing_rates b
where a.state_called=b.lata
and class_type=5
and state_called='MT'
...
substr(calledno,1,3) ||'-'|| substr(calledno,4,3) ||'-'|| substr(calledno,7,4)  "Called Number",
city_called ||', '|| state_called "Location", substr(call_duration_minutes,3,3) ||':'|| call_duration_seconds "Mins-Secs",
round(sum(((substr(call_duration_minutes,3,3)*60)+call_duration_seconds)/60) * to_number(b.class6),2) "Charge", 7 "Bill_flag"
from chinook_september a, intrastate_billing_rates b
where a.state_called=b.lata
and class_type=6
and state_called='MT'
