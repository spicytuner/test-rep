...
$phone,$n7,$cmsfqdn,$cmts,$n8,$loadvsm,$prov,$line,$mdate,$file,$val,$runall,$loadcdi,$loadcust,$sth66);
...
open(FILE4,">/home/jsoria/SCRIPTS/DATA/grandjunction.csv");
	...
	print LOG2 "Creating .csv Files for Auspice Import\n";
	$sth=$dbh->prepare(q{select distinct substr(a.cmmac, 1,2)||':'||substr(a.cmmac,3,2)||':'||substr(a.cmmac,5,2)||':'||
	...
	$sth2=$dbh->prepare(q{select distinct substr(a.cmmac, 1,2)||':'||substr(a.cmmac,3,2)||':'||substr(a.cmmac,5,2)||':'||
        substr(a.cmmac, 7,2)||':'||substr(a.cmmac,9,2)||':'||substr(a.cmmac,11,2), a.node, a.devicetype,
        null,null,null, nvl(a.mtafqdn,null),substr(a.mtamac, 1,2)||':'||substr(a.mtamac,3,2)||':'||substr(a.mtamac,5,2)||':'||
        substr(a.mtamac, 7,2)||':'||substr(a.mtamac,9,2)||':'||substr(a.mtamac,11,2),
        a.firstname, a.lastname, null,replace(a.street1,',',null), a.street2, a.city, a.state,
	...
	$sth3=$dbh->prepare(q{select distinct substr(a.cmmac, 1,2)||':'||substr(a.cmmac,3,2)||':'||substr(a.cmmac,5,2)||':'||
        substr(a.cmmac, 7,2)||':'||substr(a.cmmac,9,2)||':'||substr(a.cmmac,11,2), a.node, a.devicetype,
        null,null,null, nvl(a.mtafqdn,null),substr(a.mtamac, 1,2)||':'||substr(a.mtamac,3,2)||':'||substr(a.mtamac,5,2)||':'||
        substr(a.mtamac, 7,2)||':'||substr(a.mtamac,9,2)||':'||substr(a.mtamac,11,2),
        a.firstname, a.lastname, null,replace(a.street1,',',null), a.street2, a.city, a.state,
	...
	$sth4=$dbh->prepare(q{select distinct substr(a.cmmac, 1,2)||':'||substr(a.cmmac,3,2)||':'||substr(a.cmmac,5,2)||':'||
        substr(a.cmmac, 7,2)||':'||substr(a.cmmac,9,2)||':'||substr(a.cmmac,11,2), a.node, a.devicetype,
        null,null,null, nvl(a.mtafqdn,null),substr(a.mtamac, 1,2)||':'||substr(a.mtamac,3,2)||':'||substr(a.mtamac,5,2)||':'||
        substr(a.mtamac, 7,2)||':'||substr(a.mtamac,9,2)||':'||substr(a.mtamac,11,2),
        a.firstname, a.lastname, null,replace(a.street1,',',null), a.street2, a.city, a.state,
...
######################################
######################################
######VSM Update has not been modified
######################################
######################################
...
#sub update_VSM
#{
	#print LOG2 "Updating Auspice VSM\n";
	#my %props;
	#my $cmd_template;
#
	#open PROPS,"</home/jsoria/SCRIPTS/PERL/.properties";
	#while (<PROPS>) 
	#{
  		#s/#.*$//;
  		#chomp;
...
#close PROPS;
#
	#open MAP,"</home/jsoria/SCRIPTS/PERL/vsm_map.csv";
	#while (<MAP>) 
	#{
  		#s/#.*$//;
  		#chomp;
		...
		#{
    			#$cmd_template = 'cat /home/jsoria/SCRIPTS/PERL/update.sql | /home/jsoria/SCRIPTS/PERL/replace.pl _~_FILE_~_  | mysql -h_~_HOST_~_ -u_~_USER_~_ -p_~_PASS_~_ VSM';
