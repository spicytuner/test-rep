...
my($tablename,$indindex,$ipindex,$subpartname,$partitionname,$sth,$sth1,$sth2,$test,$usr,$passwd,$sid,$host,$runalliae,$runallse,$sql,$sthro);
...
#$sthro=$dbh->prepare(q{alter tablespace metaserv31_data read write});
#$sthro->execute();
