...
substr(calledno,1,3) ||'-'|| substr(calledno,4,3) ||'-'|| substr(calledno,7,4)  "Called Number",
city_called ||', '|| state_called "Location", substr(call_duration_minutes,3,3) ||':'|| call_duration_seconds "Mins-Secs", 
round(sum(((substr(call_duration_minutes,3,3)*60)+call_duration_seconds)/60) * to_number(b.class1),2) "Charge", 6 "Bill_flag"
...
substr(calledno,1,3) ||'-'|| substr(calledno,4,3) ||'-'|| substr(calledno,7,4)  "Called Number",
city_called ||', '|| state_called "Location", substr(call_duration_minutes,3,3) ||':'|| call_duration_seconds "Mins-Secs", 
round(sum(((substr(call_duration_minutes,3,3)*60)+call_duration_seconds)/60) * to_number(b.class2),2) "Charge", 6 "Bill_flag"
from chinook_september, interstate_billing_rates b
where intra_lata_ind=1 
and state_called not in ('IT', 'MT')
and prcmp_id != 3
...
substr(calledno,1,3) ||'-'|| substr(calledno,4,3) ||'-'|| substr(calledno,7,4)  "Called Number",
city_called ||', '|| state_called "Location", substr(call_duration_minutes,3,3) ||':'|| call_duration_seconds "Mins-Secs", 
round(sum(((substr(call_duration_minutes,3,3)*60)+call_duration_seconds)/60) * to_number(b.class3),2) "Charge", 6 "Bill_flag"
from chinook_september, interstate_billing_rates b
where intra_lata_ind=1 
and state_called not in ('IT', 'MT')
and prcmp_id != 3
...
substr(calledno,1,3) ||'-'|| substr(calledno,4,3) ||'-'|| substr(calledno,7,4)  "Called Number",
city_called ||', '|| state_called "Location", substr(call_duration_minutes,3,3) ||':'|| call_duration_seconds "Mins-Secs", 
round(sum(((substr(call_duration_minutes,3,3)*60)+call_duration_seconds)/60) * to_number(b.class4),2) "Charge", 6 "Bill_flag"
from chinook_september, interstate_billing_rates b
where intra_lata_ind=1 
and state_called not in ('IT', 'MT')
and prcmp_id != 3
...
substr(calledno,1,3) ||'-'|| substr(calledno,4,3) ||'-'|| substr(calledno,7,4)  "Called Number",
city_called ||', '|| state_called "Location", substr(call_duration_minutes,3,3) ||':'|| call_duration_seconds "Mins-Secs", 
round(sum(((substr(call_duration_minutes,3,3)*60)+call_duration_seconds)/60) * to_number(b.class5),2) "Charge", 6 "Bill_flag"
from chinook_september, interstate_billing_rates b
where intra_lata_ind=1 
and state_called not in ('IT', 'MT')
and prcmp_id != 3
...
substr(calledno,1,3) ||'-'|| substr(calledno,4,3) ||'-'|| substr(calledno,7,4)  "Called Number",
city_called ||', '|| state_called "Location", substr(call_duration_minutes,3,3) ||':'|| call_duration_seconds "Mins-Secs", 
round(sum(((substr(call_duration_minutes,3,3)*60)+call_duration_seconds)/60) * to_number(b.class6),2) "Charge", 6 "Bill_flag"
from chinook_september, interstate_billing_rates b
where intra_lata_ind=1 
and state_called not in ('IT', 'MT')
and prcmp_id != 3
